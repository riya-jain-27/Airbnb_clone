...
const BecomeAHost = () => {
    ...
    return(
        ...
        {/* {isPopupOpen ? (
            <div style={{zIndex: 2000, position: "fixed", inset: 0, maxHeight: "100vh", display: "contents"}}>
                <div style={{background: "black", position: "relative", height: "100%", maxHeight: "100%", width: "100vw", maxWidth: "100vw", display: "flex", flexDirection: "column"}}>
                    <div style={{top: 24, left: 24, zIndex: 1, display: "flex", position: "absolute"}}>
                        <IconButton onClick={()=>setIsPopupOpen(false)} style={{color: "white", height: 16, width: 16}}><CloseIcon fontSize="small" /></IconButton>
                    </div>
                    <div style={{display: "flex", alignItems: "center", justifyContent: "center", height: "100%"}}>
                        <div style={{display: "grid", overflow: "hidden", borderRadius: 16, opacity: 0.999999, willChange: "transform", width: "min(100vw, calc(100vw - 2*80px))", height: "calc(min(100vw, 100vw - 2 * 80px) / calc(375/ 812))", maxWidth: "calc(min(var(720px, 100vw), 100vw - 2 * var(48px, 0px)) / calc(375/ 812))", maxHeight: "min(var(720px, 100vh), calc(100vh - 2*var(48px,0px))"}}>
                            <div style={{height: "100%", overflow: "hidden", position: "relative", width: "100%", willChange: "transform"}}>
                                <video></video>
                            </div>
                        </div>
