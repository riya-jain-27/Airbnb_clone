    ...
    <>
      <Grid className="header">
        <div className="content">
          <div className="left">
            <div>
              <a href="/home" className="airbnb_logo">
            ...
            <div>
              <nav className="navbar">
                ...
                <div className="nav_options">
                  <button onClick={()=>setProfileOpen(!isProfileOpen)} className="profile_button">
                    <div className="bar">
                    ...
                    <div className="option_list">
                      <div>
                        <a href="" className="list_link">
                          <div className="list_text">Host your home</div>
                        </a>
                        <a href="" className="list_link">
                          <div className="list_text">Host an experience</div>
                        </a>
                        <a href="" className="list_link">
                          <div className="list_text">Help</div>
                        </a>
                        <a href="" className="list_link">
                          <div className="list_text">Log out</div>
                        </a>
                      </div>
                    </div> ) : (null)
                  }
          ...
          <div className="navbar_container">
              <div className="navbar_contents">
                <div className="navbar_flexbox">
                    <div className="navbar_tabs_section">
                        <div className="navbar_tabs_section_2">
