...
const Header = () => {
  ...
  return(
    <>
      <Grid className="header_header">
        <div className="header_content">
          <div className="header_left">
            <div>
              <a onClick={()=>navigate("/home")} className="header_airbnb_logo">
            ...
            <div>
              <nav className="header_navbar">
                <div className="header_nav_buttons">
                  <Button onClick={()=>navigate("/hostYourHome")} id="become_a_host">Become a host</Button>
                  <div className="header_globe_container">
                    <Button id="become_a_host">
                      <div className="header_globe_1">
                        <div className="header_globe_2">
                ...
                <div className="header_nav_options">
                  ...
                  {isProfileOpen ? ( 
                    <div className="header_option_list">
                      <div>
                        <a onClick={()=>navigate("/hostYourHome")} className="header_list_link">
                          <div className="header_list_text">Host your home</div>
                        </a>
                        <a onClick={()=>navigate("")} className="header_list_link">
                          <div className="header_list_text">Host an experience</div>
                        </a>
                        <a onClick={()=>navigate("/help")} className="header_list_link">
